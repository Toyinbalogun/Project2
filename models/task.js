...
class Task {
  ...
  async create () {
    ...
    const [result] = await connection.query(sql, [this.routeName, this.taskName, this.taskDescription, this.taskDeadline])
    this.id = result.id
    return this
  }
  ...
  async update () {
    ...
    await connection.query(sql, [
      { taskName: this.taskName, taskDescription: this.taskDescription, taskDeadline: this.taskDeadline },
      this.id
    ])
    return this
  }
